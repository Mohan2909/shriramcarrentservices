  ...
  return (
    <header className="sticky top-0 z-50 border-b border-zinc-200/70 bg-white/85 backdrop-blur-xl">
      <Container className="py-3 sm:py-4">
        ...
        <a href={`tel:+${contactDetails.phoneRaw}`} className="inline-flex items-center gap-2 rounded-full bg-brand-500 px-3 py-2 text-sm font-semibold text-white transition hover:bg-brand-600 sm:px-4">
